...
namespace PensionesWebApi.Controllers
{
    ...
    public class ComprobantesController : ControllerBase
    {
        ...
        public ComprobantesController(PensionesDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Comprobante>> PostComprobante(Comprobante comprobante)
        {
            ...
            return CreatedAtAction("GetComprobante", new { id = comprobante.ComprobanteId }, comprobante);
        }
        ...
        {
            return _context.Comprobantes.Any(e => e.ComprobanteId == id);
        }
    }
}
